...
class FirstHelpPage extends StatelessWidget {
  Widget _buildStartButton({required Function() onPressed}) {
  ...
  Future<void> _startGoToPage(BuildContext context) async {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildStartButton(onPressed: () => _startGoToPage(context)),
        ],
      ),
    );
  }
